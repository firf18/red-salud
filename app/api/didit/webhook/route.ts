...
const WEBHOOK_SECRET_KEY = process.env.DIDIT_WEBHOOK_SECRET || "NplZn8ap277JVQUxE6K3Ta9JlruolpnNfGzaBuAB0Ck";
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("📋 Datos completos del webhook:", JSON.stringify(jsonBody, null, 2));
