...
export const metadata: Metadata = {
  ...
  description:
    "Sistema completo de gestión de agenda médica, citas y pacientes para secretarias profesionales",
};
...
const features = [
  {
    ...
    description:
      "Sistema avanzado de gestión de citas con recordatorios automáticos y sincronización en tiempo real",
  },
  {
    icon: Users,
    title: "Gestión de Pacientes",
    description:
      "Base de datos completa con historial de citas, contactos y notas médicas",
  },
  {
    icon: Phone,
  ...
  },
  {
    ...
    description:
      "Comunicación directa con pacientes y médicos desde la plataforma",
  },
  {
    icon: FileText,
    title: "Gestión de Documentos",
    description:
      "Organiza recetas, órdenes médicas y resultados de laboratorio",
  },
  {
    icon: Clock,
    title: "Control de Disponibilidad",
    description:
      "Administra horarios, ausencias y disponibilidad de múltiples médicos",
  },
];
...
const howItWorks = [
  {
    ...
    description:
      "El médico te invita a unirte a su equipo con permisos personalizados.",
  },
  {
    icon: Settings,
    title: "2. Configura la agenda",
    description:
      "Establece horarios, duraciones de consulta y disponibilidad del médico.",
  },
  {
    icon: Calendar,
    title: "3. Gestiona citas",
    description:
      "Agenda, reprograma y cancela citas con confirmación automática.",
  },
  {
    icon: Users,
    title: "4. Administra pacientes",
    description:
      "Mantén actualizada la información de contacto y preferencias de cada paciente.",
  },
];
...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "Increíble herramienta. Ahora puedo manejar la agenda de 3 médicos sin estrés. Los recordatorios automáticos redujeron las ausencias en un 60%.",
  },
  {
    name: "Carmen Rojas",
    ...
    rating: 5,
    comment:
      "La plataforma es muy intuitiva. Me ahorra horas al día y los pacientes están encantados con los recordatorios automáticos.",
  },
  {
    name: "Isabel Torres",
    ...
    rating: 5,
    comment:
      "Perfecto para gestionar múltiples consultorios. El sistema de reportes me ayuda a optimizar los horarios constantemente.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "No. La plataforma está diseñada para ser muy intuitiva y fácil de usar. Incluimos capacitación inicial gratuita y videos tutoriales. La mayoría de las secretarias aprenden a usar todas las funciones en menos de 1 día.",
  },
  {
    question: "¿Puedo gestionar la agenda de varios médicos?",
    answer:
      "Sí, puedes gestionar las agendas de múltiples médicos desde una sola cuenta. Cada médico puede tener sus propios horarios, configuraciones y tipos de consulta. El sistema te permite cambiar fácilmente entre diferentes agendas.",
  },
  {
    question: "¿Cómo funcionan los recordatorios automáticos?",
    answer:
      "El sistema envía recordatorios automáticos a los pacientes 24 horas antes de su cita por SMS, email o WhatsApp (según preferencia). Los pacientes pueden confirmar, cancelar o reprogramar directamente desde el recordatorio.",
  },
  {
    question: "¿Qué pasa si necesito cancelar o reprogramar una cita?",
    answer:
      "Puedes cancelar o reprogramar cualquier cita con un solo clic. El sistema notificará automáticamente al paciente sobre el cambio y le ofrecerá alternativas de horarios disponibles.",
  },
  {
    question: "¿Puedo acceder al sistema desde mi teléfono?",
    answer:
      "Sí, la plataforma es 100% responsive. Puedes acceder desde computadora, tablet o smartphone. También tenemos app nativa para iOS y Android para mayor comodidad.",
  },
  {
    question: "¿El médico puede ver todo lo que hago en el sistema?",
    answer:
      "El médico puede configurar los permisos que otorga a cada secretaria. Generalmente, las secretarias tienen acceso completo a agenda, pacientes y documentos, pero los permisos son personalizables según las necesidades de cada consultorio.",
  },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Herramientas diseñadas específicamente para secretarias médicas
              profesionales
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                Secretarias profesionales están transformando su trabajo diario
                con nuestra plataforma, ahorrando tiempo y mejorando la
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-950 dark:to-purple-950 p-12 flex flex-col items-center justify-center">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold text-violet-600 dark:text-violet-400 mb-2">
                    -70%
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-violet-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-violet-100 mb-8 max-w-2xl mx-auto">
            Únete a más de 1,000 secretarias que ya están optimizando su trabajo
            diario
          </p>
