        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => (
              <div 
                key={feature.title}
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-rose-200"
              >
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-linear-to-br from-rose-50 to-pink-50 p-12 flex flex-col items-center justify-center">
                <div className="text-center mb-8">
                  ...
                  <p className="text-xl text-gray-700">Aumento en Ventas</p>
                </div>
                <div className="text-center">
                  <div className="text-6xl font-bold text-pink-600 mb-2">+500</div>
                  <p className="text-xl text-gray-700">Farmacias Activas</p>
                </div>
              </div>
            </div>
          </div>
