...
const TESTIMONIALS = [
  {
    quote:
      "Finalmente entiendo mi condición. Ahora sé qué preguntas hacerle a mi médico.",
    author: "María G.",
    condition: "Paciente con diabetes",
  },
  {
    quote:
      "Los cursos son muy fáciles de seguir. Me siento más empoderada sobre mi salud.",
    author: "José R.",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white/60 mb-8 leading-relaxed">
                ...
                tus diagnósticos, prevenir enfermedades y tomar mejores
      ...
      <section className="px-4 py-12">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <p className="text-white/50 mb-6">
            El primer módulo de cada curso es completamente gratis. No necesitas
            tarjeta de crédito.
          </p>
          <Link href="/registro?type=patient&redirect=/academy/dashboard">
            <Button
