...
export function CalendarMain({
  ...
  // Sincronizar fecha con props externas
  const [prevExternalDate, setPrevExternalDate] = useState(externalCurrentDate);
  if (externalCurrentDate && externalCurrentDate !== prevExternalDate) {
    setPrevExternalDate(externalCurrentDate);
